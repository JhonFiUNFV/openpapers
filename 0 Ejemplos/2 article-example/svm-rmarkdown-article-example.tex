...
\title{Evaluación de riesgo de liquidez de la Banca peruana en tiempo
del COVID-19 \thanks{Replication files are available on the author's
Github account (\url{http://github.com/svmiller}). \textbf{Current
version}: Junio 13, 2021; \textbf{Corresponding author}:
...
Villarreal)},
            ...
            pdftitle={Evaluación de riesgo de liquidez de la Banca
peruana en tiempo del COVID-19},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
